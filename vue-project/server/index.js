...
app.post("/login", (req, res) => {
  ...
  pool.query(sql, [email, senha], (err, result) => {
    ...
    if (result.length > 0) {
      // Retorna os dados do usuário (id, nome e se é admin ou user)
      res.send(result[0]);
    } else {
...
// Rota para Deletar Projeto (Admin)
...
app.listen(3001, () => console.log("🚀 Servidor CoNexo rodando na porta 3001"));